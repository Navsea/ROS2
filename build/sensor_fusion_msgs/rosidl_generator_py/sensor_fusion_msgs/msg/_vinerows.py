...
class Metaclass_Vinerows(type):
    """Metaclass of message 'Vinerows'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('sensor_fusion_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'sensor_fusion_msgs.msg.Vinerows')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__vinerows
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__vinerows
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__vinerows
            cls._TYPE_SUPPORT = module.type_support_msg__msg__vinerows
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__vinerows
...
class Vinerows(metaclass=Metaclass_Vinerows):
    ...
    @property
    def vinerows(self):
        """Message field 'vinerows'."""
        return self._vinerows

    @vinerows.setter
    def vinerows(self, value):
        if __debug__:
            from sensor_fusion_msg_types.msg import Vinerow
