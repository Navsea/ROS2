...
bool sensor_fusion_msg_types__msg__vinerow__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "sensor_fusion_msg_types.msg._vinerow.Vinerow",
...
{
  /* NOTE(esteve): Call constructor of Vinerow */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sensor_fusion_msg_types.msg._vinerow");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Vinerow");
